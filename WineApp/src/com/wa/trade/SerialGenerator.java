...
public class SerialGenerator implements Serializable {
	...
	public static void enregistrerCompteur(ObjectOutputStream oos) throws IOException {
		 oos.writeObject (instanceProduit);
		 oos.writeObject (instanceCommande);
	}

	public static void restituerCompteur(ObjectInputStream ois) throws ClassNotFoundException, IOException {
